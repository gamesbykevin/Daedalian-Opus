package com.gamesbykevin.daedalianopus.engine;

import com.gamesbykevin.daedalianopus.main.Main;
import com.gamesbykevin.daedalianopus.manager.Manager;
...
public final class Engine implements KeyListener, MouseMotionListener, MouseListener, IEngine 
{
    ...
    public void render(Graphics graphics) throws Exception
    {
        //get default font
        if (font == null)
            font = graphics.getFont().deriveFont(GAME_FONT_SIZE);
